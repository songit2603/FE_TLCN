                        ...
                        <div className="row">
                           <div className="col-12">
                              <div className="notification-text text-center">
                                 <p className="m-0"><b>Ưu đãi giới hạn:</b> Hiện tại, shop đang có chương trình free ship cho các đơn hàng</p>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="col-xl-3 col-lg-6 col-md-7 col-5">
                        <div className="search-main p-relative">
                              <div className="tp-header-right">
                                 ...
                                 <Link href="/login" className='ml-20'> Đăng nhập </Link>
                                 <Link href="/register" className="tp-btn-2 ml-20 d-none d-md-inline-block">Đăng ký</Link>
