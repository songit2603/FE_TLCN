                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="coupon-accordion"> 
                                <h3>Returning customer ? <Link style = {labelStyle} href="/login" className='ml-20'>Click here to login</Link></h3>
                                {/* {isLoginOpen && 
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="checkout-form-list create-acc">
                                                <input id="cbox" onClick={() => setIsOpen(!isOpen)} type="checkbox" />
                                    ...
                                    <div className="different-address">
                                        <div className="ship-different-title">
                                            <h3>
                                                ...
                                                <input id="ship-box" onClick={() => setIsShipOpen(!isShipOpen)} type="checkbox" />
                                            </h3>
                                        </div>
                                        {isShipOpen && 
